...
@class NeteaseBaseMediaObject;
@class NeteaseImageObject;

/**
 一个消息结构由三部分组成：文字、图片和多媒体数据。三部分内容中至少有一项不为空，图片和多媒体数据不能共存。
 */

@interface NeteaseShareData : NSObject
...
/**
 ...
 @see WBImageObject
 */
//@property (nonatomic, retain) NeteaseImageObject *imageObject;
 ...
 */
@property (nonatomic, retain) NeteaseBaseMediaObject *mediaObject;

/**
 返回一个 NeteaseShareData 对象
...
/**
 消息中包含的多媒体数据对象基类
 */
@interface NeteaseBaseMediaObject : NSObject
...
/**
 *  @author Victor Ji, 16-02-17 10:02:03
 *
 *  多媒体数据的URL
 */
...
/**
 返回一个 NeteaseBaseMediaObject 对象
 
 @return 返回一个*自动释放的*NeteaseBaseMediaObject对象
 */
+ (id)object;
...
/**
 消息中包含的网页数据对象
 */
@interface NeteaseWebpageObject : NeteaseBaseMediaObject
...
/**
 消息中包含的图片数据对象
 */
@interface NeteaseImageObject : NeteaseBaseMediaObject
...
/**
 ...
 @return 返回一个*自动释放的*NeteaseImageObject对象
 */
+ (id)object;
